...
при што N исто така е цел број внесен од тастатура. Дополнително, се внесува и квадратна матрица со димензии N x N. 
Програмата треба да провери колку пермутации од внесената низа можат да се најдат во 
рамките на квадратната матрица, и по редици и по колони. Притоа, проверката да се подели 
рамномерно на сите процеси, при што секој процес ќе го добие за проверка само својот дел од матрицата. 
